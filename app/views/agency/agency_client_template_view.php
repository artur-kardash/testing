              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/client/clientanalytics">Client Analytics - General</a></li>
                      <li><a href="/client/clientanalyticschannels">Client Analytics - Channels</a></li>
                      <li><a href="/client/clientanalyticsconversions">Client Analytics - Conversions</a></li>
                        <li><a href="/client/clientanalyticspdf?id=<?=$_SESSION['client_id'] ?>">Reports 1 PDF</a></li>
                      <li><a href="/searchconsole/index">Search console</a></li>
<!--                      <li><a href="/serplab/index?id=--><?//=$_GET['id'] ?><!--">Serplab</a></li>-->
                      <li><a href="/gmetrixnew/index">Gmetrix</a></li>
